...
public class CancelReservationController implements SessionController {
    ...
    public void initSession(AppSession session) {
        ...
        renderReservations(
            HotelDataBase.getGuestPendingReservation(session.getCurrentGuest()),
    ...
    public void renderReservations(ArrayList<Reservation> reservations, VBox reservationContainer) {
        ...
        for (Reservation res : reservations) {
            ...
            Label totalLabel = new Label(String.format(
                "Total Charged: $%.2f", nights * res.getRoom().getType().getBasePrice()));
